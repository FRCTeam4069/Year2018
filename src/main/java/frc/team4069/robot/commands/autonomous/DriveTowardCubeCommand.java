...
// Drive straight until the power cube is found, and then follow it
class DriveTowardCubeCommand extends CommandBase {

    // Scaling factor for the horizontal error of the cube off the center of the screen
    ...
    protected boolean isFinished() {
        return getDistanceAheadCentimeters() <= stopDistanceCentimeters;
    }
